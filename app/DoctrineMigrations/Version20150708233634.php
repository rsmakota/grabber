 ...
 */
class Version20150708233634 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE countries (id INT NOT NULL, languages TEXT NOT NULL, name VARCHAR(255) NOT NULL, native_name VARCHAR(255) NOT NULL, second_native_name VARCHAR(255) NOT NULL, iso3 CHAR(3) NOT NULL, tz VARCHAR(255) NOT NULL, iso2 CHAR(2) NOT NULL, place_id VARCHAR(255) NOT NULL, area_name VARCHAR(255) NOT NULL, prefix VARCHAR(255) NOT NULL, pattern VARCHAR(255) NOT NULL, msisdn_length INT NOT NULL, PRIMARY KEY(id))');
